    ...
    <div class="main">
        ...
        <div class="main-content">
            <div class="container-fluid">
                ...
                {{-- pengambilan data dari route user function update dengan patokan id untuk mengirimkan data form ke database --}}
                {!! Form::model($data, ['method' => 'PATCH','route' => ['user.update', $data->id], 'enctype'=>'multipart/form-data']) !!}                <div class="row">
                    {{ csrf_field() }}
                    <div class="col-md-6">
